...
if __name__ == '__main__':
    ...
    img1_path = 'D:\Desktop\Study\大三上\智能信息处理\实验七：图像检索\corel1000\\405.jpg'
    similary = []
    index = []
    for i in range(1000):
    ...
    for i in range(10):
        ...
        if itemZip[similary_sort[i]]>=400 and itemZip[similary_sort[i]]<=499:
            right_pic += 1
    print("查全率：",right_pic/100,"查准率：",right_pic/10)
    plt.show()